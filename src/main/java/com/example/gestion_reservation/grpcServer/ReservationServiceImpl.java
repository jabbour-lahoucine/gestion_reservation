...
//
//
//import com.example.gestion_reservation_grpc.*;
//import com.example.gestion_reservation_grpc.entities.Client;
//import com.example.gestion_reservation_grpc.services.ChambreService;
//import com.example.gestion_reservation_grpc.services.ClientService;
//import com.example.gestion_reservation_grpc.services.ReservationService;
...
//            Optional<com.example.gestion_reservation_grpc.entities.Chambre> chambreOptional = chambreService.getChambreById(request.getChambreId());
//
//            if (clientOptional.isPresent() && chambreOptional.isPresent()) {
//                com.example.gestion_reservation_grpc.entities.Reservation reservationEntity = new com.example.gestion_reservation_grpc.entities.Reservation(
//                        clientOptional.get(),
//                        chambreOptional.get(),
...
//                );
//
//                com.example.gestion_reservation_grpc.entities.Reservation createdReservation = reservationService.createReservation(reservationEntity);
//
...
//        try {
//            Optional<com.example.gestion_reservation_grpc.entities.Client> clientOptional = clientService.getClientById(request.getClientId());
//            Optional<com.example.gestion_reservation_grpc.entities.Chambre> chambreOptional = chambreService.getChambreById(request.getChambreId());
//
//            if (clientOptional.isPresent() && chambreOptional.isPresent()) {
//                com.example.gestion_reservation_grpc.entities.Reservation reservationEntity = new com.example.gestion_reservation_grpc.entities.Reservation(
...
//                );
//
//                com.example.gestion_reservation_grpc.entities.Reservation updatedReservation = reservationService.updateReservation(request.getId(), reservationEntity);
//
//                Reservation response = Reservation.newBuilder()
...
//        try {
//            Optional<com.example.gestion_reservation_grpc.entities.Reservation> reservationOptional = reservationService.findReservationById(request.getId());
//            if (reservationOptional.isPresent()) {
//                com.example.gestion_reservation_grpc.entities.Reservation reservationEntity = reservationOptional.get();
//
//                Reservation response = Reservation.newBuilder()
