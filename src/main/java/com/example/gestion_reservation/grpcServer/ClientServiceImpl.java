...
//        try {
//            com.example.gestion_reservation_grpc.entities.Client clientEntity = new com.example.gestion_reservation_grpc.entities.Client(
//                    request.getNom(),
//                    request.getPrenom(),
//                    request.getEmail(),
//                    request.getTelephone()
//            );
//            com.example.gestion_reservation_grpc.entities.Client createdClient = clientService.createClient(clientEntity);
//
//            com.example.gestion_reservation_grpc.Client response = com.example.gestion_reservation_grpc.Client.newBuilder()
...
//        try {
//            Optional<com.example.gestion_reservation_grpc.entities.Client> clientOptional = clientService.getClientById(request.getId());
//            if (clientOptional.isPresent()) {
//                com.example.gestion_reservation_grpc.entities.Client clientEntity = clientOptional.get();
...
//
//                com.example.gestion_reservation_grpc.entities.Client updatedClient = clientService.createClient(clientEntity);
//
//                com.example.gestion_reservation_grpc.Client response = com.example.gestion_reservation_grpc.Client.newBuilder()
...
//
//    @Override
//    public void getClient(GetClientRequest request, StreamObserver<com.example.gestion_reservation_grpc.Client> responseObserver) {
//        try {
//            Optional<com.example.gestion_reservation_grpc.entities.Client> clientOptional = clientService.getClientById(request.getId());
//            if (clientOptional.isPresent()) {
//                com.example.gestion_reservation_grpc.entities.Client clientEntity = clientOptional.get();
