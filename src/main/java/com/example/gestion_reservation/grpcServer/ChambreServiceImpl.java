...
public class ChambreServiceImpl extends ChambreServiceGrpc.ChambreServiceImplBase {
    ...
    @Override
    public void createChambre(CreateChambreRequest request, StreamObserver<com.example.gestion_reservation.Chambre> responseObserver) {
        try {
    ...
    @Override
    public void updateChambre(UpdateChambreRequest request, StreamObserver<com.example.gestion_reservation.Chambre> responseObserver) {
        try {
            Optional<com.example.gestion_reservation.entities.Chambre> chambreOptional = chambreService.getChambreById(request.getId());
            if (chambreOptional.isPresent()) {
                com.example.gestion_reservation.entities.Chambre chambreEntity = chambreOptional.get();
                ...
                com.example.gestion_reservation.entities.Chambre updatedChambre = chambreService.createChambre(chambreEntity);
    ...
    @Override
    public void getChambre(GetChambreRequest request, StreamObserver<com.example.gestion_reservation.Chambre> responseObserver) {
        try {
            Optional<com.example.gestion_reservation.entities.Chambre> chambreOptional = chambreService.getChambreById(request.getId());
            if (chambreOptional.isPresent()) {
                com.example.gestion_reservation.entities.Chambre chambreEntity = chambreOptional.get();
